...
def Entrada(dec,tipo):
    ...
    f = urllib.urlopen('http://'+server_IP+':'+app_Port+'/rfidReader?pwd1=ooKa6ieC&pwd2=of2Oobai&codTarjeta='+str(dec)+'&tipoMarca=1&tipo='+tipo+"&ipv4="+getIpv4())
    data = f.read()
    try:
...
def SalidaReceso(dec,tipo):
    ...
    frame3.pack()
    root3.config(background="black",cursor="none")
    f = urllib.urlopen('http://'+server_IP+':'+app_Port+'/rfidReader?pwd1=ooKa6ieC&pwd2=of2Oobai&codTarjeta='+str(dec)+'&tipoMarca=2&tipo='+tipo+"&ipv4="+getIpv4())
    data = f.read()
...
def EntradaReceso(dec,tipo):
    ...
    frame3.pack()
    root3.config(background="black",cursor="none")
    f = urllib.urlopen('http://'+server_IP+':'+app_Port+'/rfidReader?pwd1=ooKa6ieC&pwd2=of2Oobai&codTarjeta='+str(dec)+'&tipoMarca=3&tipo='+tipo+"&ipv4="+getIpv4())
    data = f.read()
    try:
...
def SalidaAlmuerzo(dec,tipo):
    ...
    frame3.pack()
    root3.config(background="black",cursor="none")
    f = urllib.urlopen('http://'+server_IP+':'+app_Port+'/rfidReader?pwd1=ooKa6ieC&pwd2=of2Oobai&codTarjeta='+str(dec)+'&tipoMarca=4&tipo='+tipo+"&ipv4="+getIpv4())
    data = f.read()
    try:
       # w2 = Label(root3, text=data, wraplength=650,  fg = "light green", bg = "black", font = "Helvetica 16 bold").pack()
...
def EntradaAlmuerzo(dec,tipo):
    ...
    frame3.pack()
    root3.config(background="black",cursor="none")
    f = urllib.urlopen('http://'+server_IP+':'+app_Port+'/rfidReader?pwd1=ooKa6ieC&pwd2=of2Oobai&codTarjeta='+str(dec)+'&tipoMarca=5&tipo='+tipo+"&ipv4="+getIpv4())
    data = f.read()
    try:
       # w2 = Label(root3, text=data, wraplength=650,  fg = "light green", bg = "black", font = "Helvetica 16 bold").pack()
...
def Salida(dec,tipo):
    ...
    frame3.pack()
    root3.config(background="black",cursor="none")
    f = urllib.urlopen('http://'+server_IP+':'+app_Port+'/rfidReader?pwd1=ooKa6ieC&pwd2=of2Oobai&codTarjeta='+str(dec)+'&tipoMarca=6&tipo='+tipo+"&ipv4="+getIpv4())
    data = f.read()
    try:
#        w2 = Label(root3, text=data, wraplength=650,  fg = "light green", bg = "black", font = "Helvetica 16 bold").pack()
...
def read_rfid():
 ...
 # volvería de nuevo a ejecutarse desde aquí permitiendo que se realize una y otra vez la verificacion de marcas RFID.
        while True:
 		...
 		usuarioActual=collection.find_one({'codTarjeta': dec, 'estado': 'Activo'})
...
def obtieneMarca(dec,tipo):
    print "Obteniendo marca para ID: " + str(dec) + " Tipo Usuario: " + str(tipo)
    ...
    button6 = Button(root,text="Cancelar",command=lambda: root.destroy(),fg="white",activeforeground="white",activebackground="red",bg="red",width=44,height=3,bd=0,font="Helveltica 17 bold")
...
while True:
    ...
    if dec != "None":
		...
		instUtilImg = UtilImg.UtilImg()
                photo=instUtilImg.getImageURL(str(dec)+".png")
